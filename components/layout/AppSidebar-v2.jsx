...
import { useActiveContext, usePermissions } from "@/newlib/hooks";
...
export function AppSidebar({ ...props }) {
  ...
  const handleCreateOrganization = async (orgData) => {
    try {
      const { createOrganization } = await import('@/newlib/hooks/useOrganization');
  ...
  const contextualItems = isOrganizationMode && can('canViewOrganization') ? [
    {
      title: "Organisation",
      items: [
        {
          id: "organization",
          title: currentOrganization?.name || "Organisation",
          url: "/organization",
          icon: Building2,
              ...
              <SidebarMenuButton size="lg" asChild>
                <Link href="/">
                  ...
                  <div className="flex flex-col gap-0.5 leading-none">
                    <span className="font-semibold">WiseTwin</span>
                    <span className="text-xs">Formation VR</span>
                  </div>
                </Link>
              </SidebarMenuButton>
            </SidebarMenuItem>
