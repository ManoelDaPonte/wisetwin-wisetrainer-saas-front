...
export default function InteractiveGuideModal({ guide, onComplete, onClose }) {
	...
	useEffect(() => {
		...
		const handleGameObjectSelected = (event) => {
			...
			if (data.name && data.name.includes("Controller")) {
				...
				// Envoyer un événement à Unity pour démarrer le tutoriel
