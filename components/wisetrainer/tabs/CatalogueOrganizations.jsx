...
const CatalogueOrganizations = ({
	...
	return (
		<div className="space-y-6">
			{/* Sélection d'organisation et recherche */}
			...
			{Array.isArray(userOrganizations) &&
				...
				!selectedOrgId && (
					<div className="text-center py-10">
						<p className="text-gray-500 dark:text-gray-400">
							Veuillez sélectionner une organisation pour voir ses
							formations.
						</p>
					</div>
				)}
			...
			{selectedOrgId && filteredFormations.length === 0 && (
				<div className="text-center py-10">
					<p className="text-gray-500 dark:text-gray-400">
						{searchTerm
				...
				<div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
					{filteredFormations.map((formation) => (
						<FormationCard
							...
							formation={formation}
							isEnrolled={
								typeof isUserEnrolled === "function"
									? isUserEnrolled(formation)
									: false
							}
							onEnroll={onEnroll}
...
export default CatalogueOrganizations;
